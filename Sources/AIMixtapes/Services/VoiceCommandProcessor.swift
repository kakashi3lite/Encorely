...
class VoiceCommandProcessor {
    ...
    private func detectMood(in transcript: String, segments: [VoiceSegment]) -> (Mood, Float)? {
    ...
    private func detectGenre(in transcript: String) -> (String, Float)? {
        // To be implemented - will use genre mapping similar to mood mapping
        return nil
    }
    
    private func processComplexCommand(transcript: String, segments: [VoiceSegment]) {

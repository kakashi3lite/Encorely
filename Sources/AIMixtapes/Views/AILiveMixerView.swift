                        ...
                        Menu {
                            ForEach(AudioEffect.allCases, id: \.self) { effect in
                                Button {
                                    ...
                                    aiService.trackInteraction(type: "mixer_effect_selected", metadata: ["effect": effect.rawValue])
                                } label: {
                        ...
                        Menu {
                            ForEach(TransitionType.allCases, id: \.self) { transition in
                                Button {
                                    ...
                                    aiService.trackInteraction(type: "mixer_transition_selected", metadata: ["transition": transition.rawValue])
                                } label: {
...
enum AudioEffect: String, CaseIterable {
    ...
    var icon: String {
        ...
        case .delay: return "waveform.path"
        case .filter: return "waveform.badge.plus"
        case .distortion: return "waveform.path.ecg.rectangle"
        }
    }
}
...
enum TransitionType: String, CaseIterable {
    ...
    var icon: String {
        switch self {
        case .crossfade: return "arrow.left.and.right"
        case .cut: return "scissors"
        case .fade: return "waveform.path.ecg"
        case .beatSync: return "metronome"
        }
    }
}

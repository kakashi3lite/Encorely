...
// MARK: - Preview Support
...
#if DEBUG
    extension PlayerViewModel {
        static let preview: PlayerViewModel = .init(
    ...
    class MockMusicService: MusicService {
        ...
        func stopPlayback() {
            // Mock implementation - in real app this would stop audio playback
            print("Mock: Stopping playback")
        }
        
        func pausePlayback() {
            // Mock implementation - in real app this would pause audio playback
            print("Mock: Pausing playback")
        }
        
        func resumePlayback() {
            // Mock implementation - in real app this would resume audio playback
            print("Mock: Resuming playback")
        }
        
        func seekTo(time: TimeInterval) {
            // Mock implementation - in real app this would seek to specified time
            print("Mock: Seeking to time \(time)")
        }
    ...
    class MockAudioAnalyzer: AudioAnalyzer {
        ...
        func stopRealTimeAnalysis() {
            // Mock implementation - in real app this would stop real-time audio analysis
            print("Mock: Stopping real-time analysis")
        }

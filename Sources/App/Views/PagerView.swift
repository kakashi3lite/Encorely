                ...
                LazyVStack(spacing: 12) {
                    if filteredMixtapes.isEmpty {
                        ...
                        VStack(spacing: 16) {
                            ...
                            Text("Let AI create the perfect \(selectedMood?.rawValue.lowercased() ?? "personalized") mixtape for you")
                                .font(.subheadline)
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Discover podcasts tailored to your \(aiService.personalityEngine.currentPersonality.rawValue.lowercased()) personality and \(aiService.moodEngine.currentMood.rawValue.lowercased()) mood")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)

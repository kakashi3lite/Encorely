...
class TestConfiguration {
    ...
    // Test resources
    let testAudioURL = Bundle.module.url(forResource: "test_audio", withExtension: "mp3", subdirectory: "TestResources")!
    let testImageURL = Bundle.module.url(forResource: "test_image", withExtension: "jpg", subdirectory: "TestResources")!

...
final class MoodTransitionTests: XCTestCase {
    ...
    func testNeutralFallback() {
        ...
        XCTAssertEqual(moodService.currentMood, .neutral, "Should fallback to neutral mood after consecutive low confidence")
        XCTAssertLessThan(moodService.moodConfidence, MLConfig.Analysis.confidenceThreshold, "Confidence should be low in neutral state")

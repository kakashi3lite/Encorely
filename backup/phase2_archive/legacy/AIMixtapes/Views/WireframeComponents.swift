...
final class WireframeManager: ObservableObject {
    ...
    init(moodEngine: MoodEngine, personalityEngine: PersonalityEngine) {
        ...
        currentTheme = personalityEngine.currentPersonality
    ...
    func dynamicColor(for component: WireframeComponent) -> Color {
        switch component {
        case .primary:
            modifyColorByAudioFeatures(currentTheme.themeColor)
        case .secondary:
            modifyColorByAudioFeatures(currentMood.color)
        case .accent:
            Color.accentColor
        }
    }
...
struct EnhancedWireframeButton: View {
    ...
    private var buttonBackground: Color {
        switch style {
        case .primary:
            wireframeManager.dynamicColor(for: .primary)
        case .secondary:
            Color(.systemBackground)
        case .ghost:
            Color.clear

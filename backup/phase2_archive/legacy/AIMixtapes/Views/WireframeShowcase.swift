                ...
                HStack {
                    ForEach(0 ..< 3) { index in
                        Button(action: { selectedTab = index }) {
                            ...
                            .foregroundColor(selectedTab == index ? wireframeManager
                                .dynamicColor(for: .primary) : .secondary)
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: DesignSystem.Spacing.extraLarge) {
                ...
                Text(tabTitle)
                    .font(.system(
                        size: horizontalSizeClass == .regular ? DesignSystem.FontSize.largeTitle : DesignSystem.FontSize
                            .title,
                        weight: .bold
                    ))
...
struct FocusableWireframePhone<Content: View>: View {
    ...
    var body: some View {
        ...
        .shadow(
            color: isSelected ? DesignSystem.Shadow.large : DesignSystem.Shadow.medium,

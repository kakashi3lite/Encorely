...
extension Color {
    func blended(with _: Color) -> Color {
...
struct AISuggestionBanner: View {
    ...
    private func generateSuggestion() {
        ...
        suggestion = selectMostRelevantSuggestion(from: suggestions)
